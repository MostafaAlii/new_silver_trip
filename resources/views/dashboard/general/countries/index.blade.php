...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <a data-target="#create{{$title}}" data-toggle="modal" data-effect="effect-scale" class="btn btn-success btn-sm"
                    role="button">
            ...
            @include('dashboard.general.countries.btn.modals.create')
        </div>
    </div>
</div>
<!-- row closed -->
