                ...
                <form id="newScooter" action="{{route('createNewScooter')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select name="scooter_make_id" id="scooter_makeId" class="form-control p-1 scooter_makeId scooter_make" required>
                        ...
                        <div class="form-group col-4">
                            ...
                            <select name="scooter_model_id" id="scooter_modelId" class="form-control p-1 scooter_model" required></select>
...
<script>
$(document).ready(function() {
    $('.scooter_make').select2();
    $('.scooter_model').select2();
});
</script>
