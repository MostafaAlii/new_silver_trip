                ...
                <form id="newCar" action="{{route('createNewCar')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select name="car_make_id" id="car_makeId" class="form-control p-1 car_makeId car_make">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select name="car_model_id" id="car_modelId" class="form-control p-1 car_model"></select>
                            @error('car_model_id')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
