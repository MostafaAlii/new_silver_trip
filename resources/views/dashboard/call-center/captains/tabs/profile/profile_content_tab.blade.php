                                    ...
                                    <div class="col-xl-12 md-mt-30 mb-30">
                                        <div class="card card-statistics mb-30">
                                            <div class="card-body">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <label class="custom-file-label"
                                                                                ...
                                                                                Avatar Image (الصوره الشخصية)</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <div class="custom-file">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <label class="custom-file-label"
                                                                                ...
                                                                                Record Image (الصحيفة الجنائية)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <label class="custom-file-label"
                                                                                ...
                                                                                Captain License Front (رخصة القياده
                                                                                امام)</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <label class="custom-file-label"
                                                                                for="captain_license_back"> Choose
                                                                                Captain License Back Image (رخصة القياده
                                                                                خلف)
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <label class="custom-file-label"
                                                                                ...
                                                                                License Front Image (رخصة السياره
                                                                                امام)</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <label class="custom-file-label"
                                                                                ...
                                                                                License Back Image (رخصة السياره
                                                                                خلف)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                @if(is_array($whatsappMedia) && isset($whatsappMedia['data']))
                                                <h2>WhatsApp Media</h2>
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>WhatsApp Image</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach($whatsappMedia['data'] as $index => $image)
                                                        <tr>
                                                            <td>{{ $index + 1 }}</td>
                                                            <td><img width="10%" class="rounded" src="{{ $image }}"
                                                                    alt="{{$data['captain']->name . ' WhatsApp Image' }}">
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                                @elseif(is_a($whatsappMedia, 'Illuminate\Http\RedirectResponse'))
                                                <p>No WhatsApp Media available.</p>
                                                @else
