...
'checkPhoneMessages','refresh', 'checkPhone', 'login', 'register', 'login_phone', 'restPassword','registerWhatSapp']]);
    ...
    /*public function register(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'email' => 'required|string|email|max:100|unique:captains,email',
            'phone' => 'required|numeric|unique:captains,phone',
            'gender' => 'required|in:male,female',
            'country_id' => 'required|exists:countries,id',
            'password' => 'required|string|min:6',
            'status_caption_type'=> 'required|in:car,scooter,tricycle,trunk',
            'register_type' => 'app',
    ...
    public function register(Request $request)
{
    $validator = Validator::make($request->all(), [
        ...
        'country_id' => 'required|exists:countries,id',
        'password' => 'required|string|min:6',
        'status_caption_type'=> 'sometimes|in:car,scooter,tricycle,trunk',
        'register_type' => 'app',
    ]);
    ...
    $statusCaptionType = $request->has('status_caption_type') ? $request->input('status_caption_type') : 'car';
    ...
    $user = Captain::create(array_merge(
        ...
        [
            'password' => bcrypt($request->password),
            'admin_id' => 1,
            'status_caption_type' => $statusCaptionType,
                'states_id' => 3223,
        ]
    ));
    ...
    public function registerWhatSapp(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'country_id' => 'required|exists:countries,id',
            'password' => 'required|string|min:6',
            'status_caption_type'=> 'required|in:car,scooter,tricycle',
