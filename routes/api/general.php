...
use App\Http\Controllers\Api\Orders\OrdersTrunkController;
...
//        Route::post('canselOrder', [OrderDayController::class, 'canselOrder']);
    ...
    Route::prefix('trunk')->as('trunk')->group(function () {
        Route::post('getOrder', [OrdersTrunkController::class, 'index']);
        Route::post('createOrder', [OrdersTrunkController::class, 'store']);
        Route::post('updateStatus', [OrdersTrunkController::class, 'update']);
        Route::post('canselOrder', [OrdersTrunkController::class, 'cancelOrder']);
        Route::post('checkOrder', [OrdersTrunkController::class, 'checkOrder']);
        Route::post('takingOrder', [OrdersTrunkController::class, 'takingOrder']);
        Route::post('takingCompleted', [OrdersTrunkController::class, 'takingCompleted']);
        Route::post('OrderExiting', [OrdersTrunkController::class, 'OrderExiting']);
    });
