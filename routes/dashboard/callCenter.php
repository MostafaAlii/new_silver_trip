...
Route::group(
    ...
    Route::group(['prefix' => 'callCenter', 'middleware' => ['auth:call-center','checkStatus']], function () {
        ...
        Route::resource('CallCenterCaptains', CallCenter\CaptainController::class)->parameters(['CallCenterCaptains' => 'id']);
        Route::post('callCenters/{callCenterId}/update-password', [CallCenter\CallCenterController::class, 'updatePassword'])->name('callCenters.update-password');
        ...
        Route::post('CallCenterCaptains/getwhatsappMedia/{phone}', [CallCenter\CaptainController::class, 'getwhatsappMedia'])->name('CallCenterCaptains.getwhatsappMedia');
        // Car ::
        ...
        Route::post('/captains/switch-type/{id}', [CallCenter\CaptainController::class, 'switchType'])->name('captains.switchType');
